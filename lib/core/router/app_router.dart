...
final goRouterProvider = Provider<GoRouter>((ref) {
  GoRouter router = GoRouter(
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            ...
            name: 'vehicleTypes',
            pageBuilder: (context, state) {
              return NoTransitionPage(child: VehicleTypeScreen());
            },
          ),
          GoRoute(
          ...
          GoRoute(
            ...
            name: 'payments',
            pageBuilder: (context, state) {
              return NoTransitionPage(child: const PaymentListScreen());
            },
          ),
          GoRoute(
            path: Routes.profile,
            name: 'profile',
            pageBuilder: (context, state) {
              return NoTransitionPage(child: const ProfileScreen());
            },
          ),
        ],
      ),
    ...
    redirect: (context, state) {
      final isLoggedIn = ref.read(storageServiceProvider).isLoggedIn;
